...
# Setup the Streamlit app layout
st.set_page_config(page_title="Scoracle", layout="wide")

# Define the function to navigate to different pages using iframes in the sidebar
def navigate_to_page(page):
    if page == "Plotting Demo":
        st.components.v1.iframe("pages/1_📈_Plotting_Demo.py", width=700, height=800)
    elif page == "Mapping Demo":
        st.components.v1.iframe("pages/2_🌍_Mapping_Demo.py", width=700, height=800)
    elif page == "DataFrame Demo":
        st.components.v1.iframe("pages/3_📊_DataFrame_Demo.py", width=700, height=800)
    elif page == "Team Locations":
        st.components.v1.iframe("team_locations.py", width=700, height=800)
    elif page == "Scoracle":
        st.components.v1.iframe("Scoracle.py", width=700, height=800)

# Adding a sidebar for page navigation
page = st.sidebar.selectbox(
    'Choose a page:',
    ("Home", "Plotting Demo", "Mapping Demo", "DataFrame Demo", "Team Locations", "Scoracle")
)

# Display the home page or the selected page content
if page == "Home":
    st.markdown("# Welcome to Scoracle! 🔮")
    st.markdown("Please select a page from the sidebar to display its content.")
else:
